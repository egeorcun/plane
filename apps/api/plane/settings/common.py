...
# =============================================================================
# SECURITY: Rate limiting prevents abuse and brute force attacks.
...
REST_FRAMEWORK = {
    ...
    "DEFAULT_THROTTLE_RATES": {
        "anon": "30/minute",           # Anonymous users: 30 requests per minute
        "user": "300/minute",           # SECURITY: Authenticated users: 300 requests per minute
        "asset_id": "5/minute",         # Asset operations: 5 per minute
        "upload": "30/minute",          # SECURITY: File uploads: 30 per minute
        "search": "60/minute",          # SECURITY: Search operations: 60 per minute
        "auth": "10/minute",            # SECURITY: Auth operations: 10 per minute (stricter for security)
    },
...
# CORS SETTINGS
# =============================================================================
# SECURITY: CORS (Cross-Origin Resource Sharing) controls which domains can
# make requests to the API. Misconfigured CORS can lead to data exposure.
#
# IMPORTANT: CORS_ALLOW_ALL_ORIGINS should NEVER be True in production.
# Always set CORS_ALLOWED_ORIGINS environment variable with specific domains.
# =============================================================================
